  ...
  return (
    <>
      ...
      <section className="bg-black flex max-md:mb-20 max-md:w-full">
        <img
          className="w-4/5 max-md:hidden"
          src="/assets/homepageMain(1).jpg"
          alt=""
        />
        ...
        <div className="w-3/5 flex flex-col items-center">
          ...
          <div className="flex gap-10 max-md:flex-col">
            <TrainerCard
              ...
              name="John Deer"
              subject="Crossfit Trainer"
            />
            <TrainerCard
              src="/assets/trainer2.jpg"
              name="Kate Priest"
              subject="Yoga Trainer"
            />
            <TrainerCard
      ...
      <section className="flex justify-center my-32">
        <div className="flex items-end lg:w-3/5 border-b-8 border-[#f97316]">
          <img
            className="h-full object-fill rounded-tr-[25%] max-md:hidden"
            src="/assets/testimonial.jpg"
            alt="testimonial"
          />
          <div className="flex flex-col justify-center gap-3 text-white bg-black max-h-[75%] min-w-[60%] px-[10%] py-[5%] max-md:py-40">
            <img className="h-24 w-24" src="/assets/quotes.svg" alt="quotes" />
            <p className="pb-5 font-light">
              "I've been a member of GymRat for the past 6 months and it has
