...
const ContactPage = () => {
  ...
  return (
    <div>
      ...
      <div className="w-3/5 mx-auto grid grid-cols-2 my-40 gap-20 max-md:grid-cols-1">
        <div>
        ...
        <div className="bg-[#f8f8f8] p-10">
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
            ...
            <input
              ...
              className="my-4 mt-10 p-4 outline-none"
            />
            <input
              {...register("email")}
              id="email"
              ...
              className="my-4 p-4 outline-none"
            />
            <select
              {...register("class")}
              id="class"
            ...
            <div className="flex justify-center my-4">
              <button className="border-2 px-8 py-2 rounded-full font-semibold text-sm bg-[#f97316] hover:bg-[#f8f8f8] text-white hover:text-black duration-200">
                SUBMIT NOW
              </button>
            </div>
          </form>
