    ...
    <section className="flex justify-center mt-28">
      <div className="flex w-3/5">
        <div className="flex flex-col gap-10 max-md:mb-32">
          <h1 className="font-bold text-4xl max-md:text-3xl max-md:text-center">
            {title}
          </h1>
          ...
          <div className="flex gap-5 text-center max-md:flex-col">
            ...
            />
            <HomePageIcon
              src="/assets/globe-hemisphere-west.svg"
        ...
        <img
          className="max-h-[600px] max-w-[500px] max-md:hidden"
          src="/assets/female-runner.jpg"
          alt="runner"
        />
      </div>
    </section>
